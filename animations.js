...
team.from('.team #back', 0.5, {
    ...
    .from('.team #person4', 0.5, {
        x: 400,
        opacity: 0
    }, "team")
    .from('.team #person2', 0.5, {
        y: -400,
        opacity: 0
    }, "team")
    .from('.team #person3', 0.5, {
        y: -300,
        opacity: 0
    }, "team")
...
about.addLabel('header').from('.header h2', 0.3, {
        y: -70,
        opacity: 0,
    }).from('.header p', 0.3, {
        opacity: 0,
...
services.from('#services .desc', 0.5, {
    x: -400,
    opacity: 0
}).from('.build #window', 0.4, {
    y: -300,
    opacity: 0
}).addLabel('tabs').from('.build #tabs g', 0.4, {
    scale: 0,
    transformOrigin: '50% 50%',
    stagger: 0.15
...
socials.from('#social .desc', 0.5, {
        x: -400,
        opacity: 0,
    }).addLabel("floor").from('#box', 0.3, {
        y: -650,
        opacity: 0,
        stagger: 0.15
    }).from('#floor', .4, {
